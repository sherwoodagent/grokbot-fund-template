...
| 15 | Morpho/CL cookbook | `workspace/ops/morpho-cl-cookbook.md` (market evidence) + `skills/sherwood-ops` (`morpho-supply` / `concentrated-liquidity` CLI keys since CLI 0.90.4; CL is V3 + Morpho, not v4 equity LP) |
